 ...
 */
YUI.add('moodle-form-schemacheckboxcontroller', function(Y) {
    ...
    Y.extend(checkboxcontroller, Y.Base, {
        ...
        switchGroupState : function() {
            if (this._checkboxclass) {
                ...
                var checkboxes = Y.all(this._checkboxclass+'1');
                checkboxes.each(function(checkbox){
                    if (newvalue == 'checked') {
                        
                        checkbox.set('checked', 'checked');
                        //checkbox.set('disabled', 0);
                ...
                if (newvalue == 'checked') {
                    ...
                    lastbox.set('checked', 'checked');
                }
                lastbox.simulate('click');
                
                //M.form.dependencyManager.checkDependencies();
