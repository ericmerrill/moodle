...
define('GRADE_GRADE_DISPLAY_HIDE_TOTAL_IF_CONTAINS_HIDDEN', 0);
define('GRADE_GRADE_DISPLAY_SHOW_TOTAL_IF_CONTAINS_HIDDEN', 1);
define('GRADE_GRADE_DISPLAY_SHOW_REAL_TOTAL_IF_CONTAINS_HIDDEN', 2);
define('GRADE_GRADE_DISPLAY_HIDDEN', 3);
