...
class core_gradelib_testcase extends advanced_testcase {
    ...
    public function test_grade_calculate_percentage() {
        // Simple percentage math.
        $this->assertEquals(50.000, grade_calculate_percentage(50, 0, 100));
        $this->assertEquals(10.000, grade_calculate_percentage(10, 0, 100));

        // The more complicated non-zero minimums.
        $this->assertEquals(0.000, grade_calculate_percentage(5, 5, 55));
        $this->assertEquals(90.000, grade_calculate_percentage(50, 5, 55));
        $this->assertEquals(-10.000, grade_calculate_percentage(0, 5, 55));
        $this->assertEquals(120.000, grade_calculate_percentage(65, 5, 55));
    }
}
