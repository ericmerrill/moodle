...
class core_course_external extends external_api {
    ...
    public static function search_courses_parameters() {
        return new external_function_parameters(
            array(
                ...
                'limittoenroled' => new external_value(PARAM_BOOL, 'limit to enrolled courses', VALUE_DEFAULT, 0),
            )
        );
    }
     ...
     * @param int $limittoenroled   Limit to only enrolled courses
    ...
    public static function search_courses($criterianame,
        ...
        if (!empty($limittoenroled)) {
            // Get the courses where the current user has access.
            $enroled = enrol_get_my_courses(array('id', 'cacherev'));
        }
