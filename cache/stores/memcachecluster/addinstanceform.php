 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class cachestore_memcachecluster_addinstance_form extends cachestore_addinstance_form {
    ...
    protected function configuration_definition() {
        $form = $this->_form;
        $form->addElement('textarea', 'getservers', 'Fetch Servers', array('cols' => 75, 'rows' => 5));
        $form->addHelpButton('getservers', 'servers', 'cachestore_memcache');
        $form->addRule('getservers', get_string('required'), 'required');
        $form->setType('getservers', PARAM_RAW);

        $form->addElement('textarea', 'setservers', 'Set Servers', array('cols' => 75, 'rows' => 5));
        $form->addHelpButton('setservers', 'servers', 'cachestore_memcache');
