...
$string['noprogresstimeout'] = 'No progress timeout';
$string['noprogresstimeout_desc'] = 'In some long-running actions which display progress bars, such as backup and restore, the system will time out if no progress occurs for this many seconds.';
