...
class converter {
    ...
    /**
     * Convert a document to a new format and return a new stored_file for the converted file.
     *
     * @param   stored_file $file The file to convert
     * @param   string $target The desired target file format (file extension)
    ...
    public function start_conversion(stored_file $file, $format, $forcerefresh = false) {
        ...
        return $this->poll_conversion($conversion);
    }

    /**
     * Poll a conversion for updates.
     *
     ...
     * @return  string|false
     */
    public function get_next_converter($converters, $currentconverter = null) {
        if ($currentconverter) {
