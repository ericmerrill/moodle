    ...
    if (!during_initial_install()) {
        if (!function_exists('solr_get_version')) {
            ...
            $settings->add(new admin_setting_configtext('search_solr/maxindexfilekb',
                    ...
                    new lang_string('maxindexfilekb_help', 'search_solr'), '262144', PARAM_INT));
            $settings->add(new admin_setting_configcheckbox('search_solr/indexunknownfiles',
                    new lang_string('indexunknownfiles', 'search_solr'),
                    new lang_string('indexunknownfiles_help', 'search_solr'), 0));
        }
    }
}
