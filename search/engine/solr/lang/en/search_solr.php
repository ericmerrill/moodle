...
$string['indexunknownfiles'] = 'Index files with unknown type';
$string['indexunknownfiles_help'] = 'For files which Moodle does not know the type, Solr still may be able to extract userful information. If enabled, we will still try to index these files.';
$string['maxindexfilekb'] = 'Maximum file size to index (KB)';
$string['maxindexfilekb_help'] = 'Files larger than this number of kilobytes will be skipped for search indexing';
